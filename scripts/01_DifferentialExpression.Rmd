...
```{r}
salmon_quant <- function(samplename, index, fastqdir = 'fake_fastq') {
...
```{r eval=FALSE}
salmon_quant('SRR1565929', "gencode.v26", 'fake_fastq')
```
